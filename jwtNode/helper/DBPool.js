...
//설정 파일 내용 가져오기
dotenv.config({path:join(resolve(),"../config1.env")});
...
class DBPool {
    ...
    static connectionInfo = {
        ...
        port: process.env.DATABASE_PORT,                //my sql 포트번호
     ...
     * 각 이벤트는 DBConnection의 생성, 임대, 반납 여부를 모니터링하고
    ...
    /**
     * Connection Pool 에서 하나의 데이터베이스 접속 객체를 임대하는 메서드
     *
     */
    async getConnection() {
        let dbcon = null
